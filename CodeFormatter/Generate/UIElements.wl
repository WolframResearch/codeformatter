...
(* dark-mode support
  * only available to 14.3+, generated files found in CodeFormatter/DarkModeSupport
  * dominant colors:
    Palette: GrayLevel[0.95]
    Dialogs: GrayLevel[1] (buttons are individually reverse-contrast areas with 3 button types Red1/Orange1/Blue1 copied from 14.3 Dialog.nb)
  * dialog colors use 1-arg LightDarkSwitched
  * most palette colors use 2-arg LightDarkSwitched
*)
BuildWithDarkModeSupportQ; (* Block this with a value at build-time *)

grayLevel[{args__}, {darkArgs___}, ___] := GrayLevel[args]
grayLevel[{args__}, "Same"] := GrayLevel[args]
grayLevel[{args__}, {}, ___] := System`LightDarkSwitched[GrayLevel[args]] /; TrueQ[BuildWithDarkModeSupportQ]
grayLevel[{args__}, {darkArgs__}, ___] := System`LightDarkSwitched[GrayLevel[args], GrayLevel[darkArgs]] /; TrueQ[BuildWithDarkModeSupportQ]

rgbColor[{args__}, "Same"] := RGBColor[args]
rgbColor[{args__}, {darkArgs___}, ___] := RGBColor[args]
rgbColor[{args__}, {}, ___] := System`LightDarkSwitched[RGBColor[args]] /; TrueQ[BuildWithDarkModeSupportQ]
rgbColor[{args__}, {darkArgs__}, ___] := System`LightDarkSwitched[RGBColor[args], RGBColor[darkArgs]] /; TrueQ[BuildWithDarkModeSupportQ]


CodeFormatter`$optsPath = Splice[{CodeAssistOptions, "CodeToolsOptions", "CodeFormat"}];


BackgroundCol := grayLevel[{.95}, {0.2325100}, "Background"];
...
delimiter = Graphics[
  {
    AbsoluteThickness[1], grayLevel[{.6}, {0.6998500}, "Feature"], CapForm["Round"],
    Line[{{0, 0}, {0, 1}}]
  },
...
delimiter2 =
Graphics[
  {grayLevel[{.8}, {0.4812700}, "Feature"], AbsoluteThickness[1], CapForm["Round"], Line[{{0, 0}, {1, 0}}]},
...
Framed[
  label,
  RoundingRadius -> 3, ImageSize -> size, Alignment -> Center, Background -> grayLevel[{1}, {0.27859}, "Background"],
  FrameStyle -> (Dynamic[If[CurrentValue["MouseOver"],
    Directive["CodeFormatterHighlightColor", AbsoluteThickness[1]],
    Directive[#1, AbsoluteThickness[1]]]]&[grayLevel[{.7}, {0.60033}, "Feature"]]),
  BaseStyle -> "CodeFormatterText"
]
...
Graphics[
  {
    (* Draw the slider bar. *)
    AbsoluteThickness[2.5], grayLevel[{.75}, {0.0233300}, "Background"], CapForm["Round"],
    Line[{Offset[{-8, 0}, {-1, 0}], Offset[{8, 0}, {1, 0}]}],
    (* Ticks *)
    Disk[{#, 0}, Offset[2.5]]& /@ Range[-1, 1, .2],
    (* Handle *)
    FaceForm[grayLevel[{1}, {0.27859}, "Background"]],
    Dynamic[
      EdgeForm[Directive[
        AbsoluteThickness[1],
    ...
    Dynamic[
      Style[
        ...
        If[highlightQ, "CodeFormatterHighlightColor", System`EdgeColor -> #1]],
      TrackedSymbols :> {highlightQ}
    ]&[grayLevel[{.6}, {0.6998500}, "Feature"]]},
  PlotRange -> {{-1, 1}, {-1, 1}},
...
With[
  ...
  Row[{
    DenseIcon[grayLevel[{.4}, {0.8557800}, "Feature"]],
    DynamicModule[
    ...
    AiryIcon[grayLevel[{.4}, {0.8557800}, "Feature"]]
    }]
]
...
aRules := <|(* These control the individual setter appearance and mouse effects *)
  "Alignment" -> Center,
  "FontColorDefault" -> grayLevel[{0.2}, {0.9609200}, "Feature"],
  "FontColorHover" -> rgbColor[{0.86667, 0.06667, 0}, {0.7086, 0.20705, 0.08815}, "Feature"],
  "FrameMarginHorizontal" -> 7.5,
  "FrameMarginVertical" -> 0,
  "OverlapPercentage" -> 0.125,
  "RoundingRadius" -> 3,
  "SelectionBackground" -> grayLevel[{0.98}, {0.2601500}, "Background"],
  "SelectionFontColor" -> grayLevel[{0.2}, {0.9609200}, "Feature"],
  "SelectionFrameStyleDefault" -> Directive[grayLevel[{0.7}, {0.60033}, "Feature"], AbsoluteThickness[1]],
  "SelectionFrameStyleHover" -> Directive[rgbColor[{0.86667, 0.06667, 0}, {0.7086, 0.20705, 0.08815}, "Feature"], AbsoluteThickness[1]]|>;


Options[RoundedSetterBar] = {
  (* Background -> grayLevel[{1}, {0.27859}, "Background"], *)
  BaseStyle -> "CodeFormatterText",
...
Module[
  ...
  With[
    {
      d = Lookup[ar, "SelectionFrameStyleDefault", grayLevel[{0}, {1.}, "Feature"]],
      h = Lookup[ar, "SelectionFrameStyleHover", rgbColor[{0.86667, 0.06667, 0}, {0.7086, 0.20705, 0.08815}, "Feature"]]},
    setSelectionFrameStyle[j_] := Dynamic[If[settingIndex === j, If[hoverQ, h, d], None]]
  ];
  With[
    {
      d = Lookup[ar, "FontColorDefault", grayLevel[{0}, {1.}, "Feature"]],
      h = Lookup[ar, "FontColorHover", rgbColor[{0.86667, 0.06667, 0}, {0.7086, 0.20705, 0.08815}, "Feature"]],
      s = Lookup[ar, "SelectionFontColor", grayLevel[{0}, {1.}, "Feature"]]},
    setBaseStyle[j_] := (* FontColor needs to be replaced within BaseStyle such that the mouse effect applies as we enter the ButtonBox *)
      If[FreeQ[OptionValue[BaseStyle], FontColor],
        Append[Flatten[{OptionValue[BaseStyle]}], FontColor -> Dynamic[If[settingIndex === j, s, If[CurrentValue["MouseOver"], h, d]]]]
        , 
        Replace[Flatten[{OptionValue[BaseStyle]}], HoldPattern[FontColor -> v_] :> FontColor -> Dynamic[If[settingIndex === j, s, If[CurrentValue["MouseOver"], h, d]]], {1}]]
  ];
  ...
  With[
    {
      default = Replace[OptionValue[FrameStyle], Automatic -> Directive[AbsoluteThickness[1], grayLevel[{0.8}, {0.4812700}, "Feature"]]],
      hover = Lookup[ar, "SelectionFrameStyle", Directive[rgbColor[{0.86667, 0.06667, 0}, {0.7086, 0.20705, 0.08815}, "Feature"], AbsoluteThickness[1]]]},
...
Graphics[
  {
    ...
    {
      FaceForm[{grayLevel[{0.901961}, {0.32756}, "Feature"], Opacity[1.]}],
    ...
    {
      grayLevel[{0.698039}, {0.60245}, "Feature"], Thickness[0.03229278794402584], Opacity[1.], CapForm["Butt"], JoinForm[{"Miter", 10.}],
    ...
    {
      FaceForm[{grayLevel[{0.698039}, {0.60245}, "Feature"], Opacity[1.]}],
...
Graphics[
  {
    ...
    Style[
      ...
      CapForm["Butt"], JoinForm[{"Miter", 10.}], Thickness[0.031185031185031183], grayLevel[{0.698039}, {}]],
    Style[
...
Graphics[
  {
    ...
    {
      grayLevel[{0.698039}, {0.60245}, "Feature"], Thickness[0.03229278794402584], Opacity[1.], CapForm["Butt"],
...
Tooltip[
  DynamicModule[{hoverQ},
    DynamicWrapper[
      Graphics[
        {
          EdgeForm[], Dynamic[FaceForm[If[hoverQ, #1, #2]]]&[grayLevel[{.84}, {0.1312}, "Background"], grayLevel[{.9}, {0.1865000}, "Background"]],
          Disk[{0, 0}, 1],
          Text[
            Style["?", FontFamily -> "Source Sans Pro", 10.5, FontWeight -> Plain, FontColor -> grayLevel[{.2}, {0.9609200}, "Feature"]],
            {0, 0},
            {-.23, .15}]},
...
Framed[
  ...
  Background -> grayLevel[{1}, {0.27859}, "Background"],
  FrameStyle -> Directive[AbsoluteThickness[1], grayLevel[{0.941176}, {0.25191}, "Feature"]],
  RoundingRadius -> 3,
  ...
  Column[
    {
      ...
      Pane[
        ...
        FrameMargins -> 1.5{{4, 4}, {4, 4}}]},
    Spacings -> {{}, {1, 1, 1}},
    Background -> {grayLevel[{0.901961}, {0.18831}, "Background"], grayLevel[{0.980392}, {0.26051}, "Background"]}
  ],
  BaseStyle -> {"CodeFormatterText", FontSize -> 12, LineSpacing -> {1, 0}, LineIndent -> 0},
  ImageSize -> {185, All},
  FrameMargins -> 0,
  FrameStyle -> Directive[grayLevel[{0.854902}, {0.4040600}, "Feature"], AbsoluteThickness[1]]]
...
With[{$optsPath = CodeFormatter`$optsPath},
  Row[{
    ...
    Grid[
      {
        {
          Style[tr["Break" <> title], FontSize -> 12.5, FontColor -> grayLevel[{.2}, {0.9609200}, "Feature"]],
...
With[
  ...
  EventHandler[
    Framed[
      optionTogglerList,
      Background -> grayLevel[{.99}, {0.26937}, "Background"],
      FrameMargins -> {{4, 0}, {4, 4}},
      FrameStyle -> grayLevel[{.7}, {0.60033}, "Feature"],
      ImageSize -> Automatic,
      Alignment -> Center,
      RoundingRadius -> 4],
    {
...
Notebook[{
  ...
  Cell[StyleData["DialogTextBasic"],
    ...
    FontSize->13,
    PrivateFontOptions->{"OperatorSubstitution"->False}],
  Cell[StyleData["DialogTextCommon", StyleDefinitions -> StyleData["DialogTextBasic"]],
    ...
    LineIndent->0,
    LinebreakAdjustments->{1., 10, 1, 0, 1},
    FontColor->grayLevel[{0.39215686274509803`}, {}]],
  Cell[StyleData["DialogHeader", StyleDefinitions -> StyleData["DialogTextCommon"]],
    CellMargins->{{30, 30}, {13, 11}},
    FontSize->22,
    FontColor->grayLevel[{0.2}, {}]],
  Cell[StyleData["DialogBody", StyleDefinitions -> StyleData["DialogTextCommon"]],
    CellMargins->{{30, 30}, {24, 24}}],
  Cell[StyleData["DialogFooter", StyleDefinitions -> StyleData["DialogTextCommon"]],
    CellMargins->{{30, 30}, {15, 15}}],
  ...
  Cell[StyleData["ButtonOrange1Normal", StyleDefinitions -> StyleData["ButtonCommonOptions"]],
    FontColor->grayLevel[{1}, "Same"],
    Background->rgbColor[{0.95686, 0.36471, 0.15686}, {0.79216, 0.34978, 0.16546}]],
  Cell[StyleData["ButtonOrange1Hover", StyleDefinitions -> StyleData["ButtonCommonOptions"]],
    FontColor->grayLevel[{1}, "Same"],
    Background->rgbColor[{0.9451, 0.47843, 0.21569}, {0.79989, 0.43787, 0.21401}]],
  Cell[StyleData["ButtonOrange1Pressed", StyleDefinitions -> StyleData["ButtonCommonOptions"]],
    FontColor->grayLevel[{1}, "Same"],
    Background->rgbColor[{0.77255, 0.03922, 0.}, {0.55354, 0.18117, 0.08034}]],
  Cell[StyleData["ButtonOrange1Disabled", StyleDefinitions -> StyleData["ButtonCommonOptions"]],
    FontColor->grayLevel[{1}, "Same"],
    FontOpacity->0.5,
    Background->rgbColor[{0.95686, 0.36471, 0.15686, 0.5}, {0.79216, 0.34978, 0.16546, 0.5}]],
  
  Cell[StyleData["ButtonBlue1Normal", StyleDefinitions -> StyleData["ButtonCommonOptions"]],
    FontColor->grayLevel[{1}, "Same"],
    Background->rgbColor[{0.17647, 0.45882, 0.72941}, {0.24348, 0.39757, 0.5906}]],
  Cell[StyleData["ButtonBlue1Hover", StyleDefinitions -> StyleData["ButtonCommonOptions"]],
    FontColor->grayLevel[{1}, "Same"],
    Background->rgbColor[{0.24314, 0.6, 0.93725}, {0.30933, 0.53805, 0.80407}]],
  Cell[StyleData["ButtonBlue1Pressed", StyleDefinitions -> StyleData["ButtonCommonOptions"]],
    FontColor->grayLevel[{1}, "Same"],
    Background->rgbColor[{0.14118, 0.40392, 0.63922}, {0.20206, 0.34293, 0.50847}]],
  Cell[StyleData["ButtonBlue1Disabled", StyleDefinitions -> StyleData["ButtonCommonOptions"]],
    FontColor->grayLevel[{1}, "Same"],
    FontOpacity->0.5,
    Background->rgbColor[{0.17647, 0.45882, 0.72941, 0.5}, {0.24348, 0.39757, 0.5906, 0.5}]],
  
  Cell[StyleData["ButtonRed1Normal", StyleDefinitions -> StyleData["ButtonCommonOptions"]],
    FontColor->grayLevel[{1}, "Same"],
    Background->rgbColor[{0.86667, 0.06667, 0}, {0.7086, 0.20705, 0.08815}]],
  Cell[StyleData["ButtonRed1Hover", StyleDefinitions -> StyleData["ButtonCommonOptions"]],
    FontColor->grayLevel[{1}, "Same"],
    Background->rgbColor[{0.99608, 0, 0}, {0.82786, 0.2295, 0.10395}]],
  Cell[StyleData["ButtonRed1Pressed", StyleDefinitions -> StyleData["ButtonCommonOptions"]],
    FontColor->grayLevel[{1}, "Same"],
    Background->rgbColor[{0.6902, 0.05882, 0}, {0.54062, 0.16337, 0.06755}]],
  Cell[StyleData["ButtonRed1Disabled", StyleDefinitions -> StyleData["ButtonCommonOptions"]],
    FontColor->grayLevel[{1}, "Same"],
    FontOpacity->0.5,
    Background->rgbColor[{0.86667, 0.06667, 0, 0.5}, {0.7086, 0.20705, 0.08815, 0.5}]],
  
  Cell[StyleData["ButtonGray1Normal", StyleDefinitions -> StyleData["ButtonCommonOptions"]],
    FontColor->grayLevel[{20/51}, {}],
    Background->grayLevel[{229/255}, {}]],
  Cell[StyleData["ButtonGray1Hover", StyleDefinitions -> StyleData["ButtonCommonOptions"]],
    FontColor->grayLevel[{20/51}, {}],
    Background->grayLevel[{49/51}, {}],
    FrameBoxOptions->{FrameStyle->{grayLevel[{229/255}, {}]}}],
  Cell[StyleData["ButtonGray1Pressed", StyleDefinitions -> StyleData["ButtonCommonOptions"]],
    FontColor->grayLevel[{1}, {}],
    Background->grayLevel[{166/255}, {}]],
  Cell[StyleData["ButtonGray1Disabled", StyleDefinitions -> StyleData["ButtonCommonOptions"]],
    FontColor->grayLevel[{20/51}, {}],
    FontOpacity->0.5,
...
Graphics[
  {
    ...
    {
      FaceForm[{grayLevel[{.18}, {0.}, "Background"]}],
      Line[{{5, 5}, {10, 10}}],
      Line[{{5, 10}, {10, 5}}]}},
...
Graphics[
  {
    Thickness[0.067], 
    {
      ...
      JoinedCurve[{{{1, 4, 3}, {1, 3, 3}, {1, 3, 3}, {1, 3, 3}}}, {{{14.427999999999999, 7.463000000000021}, {14.427999999999999, 3.616890000000021}, {11.31011, 0.49900000000002187}, {7.4639999999999995, 0.49900000000002187}, {3.617889, 0.49900000000002187}, {0.5, 3.616890000000021}, {0.5, 7.463000000000021}, {0.5, 11.309111000000021}, {3.617889, 14.427000000000021}, {7.4639999999999995, 14.427000000000021}, {11.31011, 14.427000000000021}, {14.427999999999999, 11.309111000000021}, {14.427999999999999, 7.463000000000021}}}, CurveClosed -> {0}]},
    {
      FaceForm[{grayLevel[{.18}, {0.9684400}, "Feature"]}],
...
With[
  ...
  roundedRectButton[
    CreateDialog[
      ...
      Modal -> True,
      Background -> Dynamic[If[BoxForm`SufficientVersionQ[14.3], System`SystemColor["Window"], CurrentValue[{"SystemColors", "Window"}]]],
      StyleDefinitions -> ss],
    tr["PresetsSaveAs"],
    "Gray2",
    {
...
With[
  ...
  DynamicWrapper[
    Tooltip[
      EventHandler[
        Mouseover[
          penIcon[Dynamic[#1]]& @ grayLevel[{0.7}, {0.60033}, "Feature"],
...
With[{$optsPath = CodeFormatter`$optsPath},
  DynamicWrapper[
    Tooltip[
      EventHandler[
        Mouseover[
          deleteIcon[Dynamic[#1]]& @ grayLevel[{0.7}, {0.60033}, "Feature"],
