...
With[
  {
    ...
    $optsPath = CodeFormatter`$optsPath,
    dialogStylesheet = dialogStylesheet
  },
  ...
  roundedRectButton[
    CreateDialog[
      ...
      StyleDefinitions -> dialogStylesheet],
    tr["PresetsSaveAs"],
    "Gray2",
    {
      ImageSize -> Automatic,
