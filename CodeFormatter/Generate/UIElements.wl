...
grayLevel[{args__}, {___}, ___] := GrayLevel[args]
...
rgbColor[{args__}, {___}, ___] := RGBColor[args]
...
Graphics[
  {
    ...
    {
      FaceForm[{grayLevel[{0.901961}, {}, "Content"], Opacity[1.]}],
    ...
    {
      grayLevel[{0.698039}, {}, "Content"], Thickness[0.03229278794402584], Opacity[1.], CapForm["Butt"], JoinForm[{"Miter", 10.}],
    ...
    {
      FaceForm[{grayLevel[{0.698039}, {}, "Content"], Opacity[1.]}],
...
Graphics[
  {
    ...
    {
      grayLevel[{0.698039}, {}, "Content"], Thickness[0.03229278794402584], Opacity[1.], CapForm["Butt"],
...
With[
  ...
  roundedRectButton[
    CreateDialog[
      ...
      Modal -> True,
      Background -> Dynamic[FEPrivate`If[FEPrivate`GreaterEqual[FrontEnd`$NotebookVersionNumber, 14.3], System`SystemColor["Window"], CurrentValue[{"SystemColors", "Window"}]]],
      StyleDefinitions -> ss],
    tr["PresetsSaveAs"],
    "Gray2",
    {
